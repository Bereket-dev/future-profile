...
function buildPrompt({ answers, scores, predictions }) {
  return `
You are FutureBond AI, an AI-powered relationship insights writer.
...
export async function generateGeminiInsights({ answers, scores, predictions }) {
  ...
  try {
    ...
    return {
      ...
      timeline: "People with similar profiles often experience relationships in phases: connection, alignment, then deeper commitment."
    };
  }
}
